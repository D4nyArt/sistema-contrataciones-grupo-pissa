...
const DownloadBatchFilesButton: React.FC<Props> = ({expedienteId}) => {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="px-3.5 py-2 bg-blue-800 text-white rounded-lg disabled:bg-gray-400 disabled:cursor-not-allowed hover:bg-blue-100 hover:text-blue-800 transition-colors cursor-pointer"
    >
