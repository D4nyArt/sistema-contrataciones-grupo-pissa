      ...
      try {
        ...
        try {
          ...
          if (usersSnapshot.exists()) {
            ...
            console.log("Número de usuarios encontrados:", Object.keys(usersData).length);
        ...
        if (!uid) {
          ...
          setAlertaRecuperar({
            type: 'errorSist',
            mensaje: 'El correo electrónico no está dado de alta en el sitio. Contacte al administrador.'
          });
          return;
        }
        /***************************************************************/
        ...
        try {
          ...
          switch(estadoUsuario) {
            case 'previo':
              setAlertaRecuperar({
                type: 'info',
                mensaje: 'Su cuenta aún no está activa. Por favor, contacte al administrador.'
              });
              break;
            ...
            case 'bloqueado':
              ...
              try {
                ...
                setAlertaRecuperar({
                  type: 'aprobado',
                  mensaje:'Su solicitud se generó correctamente. Verifique su correo electrónico para continuar el proceso'
                });
              } catch (error) {
                console.error("Error al procesar la solicitud:", error);
                setAlertaRecuperar({
                  type: 'errorSist',
                  mensaje: 'Error al procesar la solicitud. Intente nuevamente más tarde.'
                });
              }
              break;
            ...
            case 'enProceso':
              setAlertaRecuperar({
                type: 'info',
                mensaje: 'Ya tiene una solicitud en curso. Espere al administrador'
              });
              break;
            ...
            case 'inhabilitado':
              setAlertaRecuperar({
                type: 'denegado',
                mensaje: 'Su cuenta no puede ser recuperada, está inactiva temporalmente'
              });
              break;
            ...
            case 'baja':
              setAlertaRecuperar({
                type: 'denegado',
                mensaje: 'Su cuenta fue bloqueada de forma permanente. Es imposible recuperarla'
              });
              break;
          ...
          setAlertaRecuperar({
            type: 'errorSist',
            mensaje: 'Error al obtener el estado del usuario. Intente de nuevo más tarde.'
          });
        }
          ...
          <div className="mb-4">
            <input
              ...
              className={`w-full p-2 border rounded-lg mt-1 bg-[#fafbfc] ${
                (formSubmitted && alertaRecuperar && 
                (alertaRecuperar.mensaje.includes('formato del correo') || 
                 alertaRecuperar.mensaje.includes('correo electrónico no existe') ||
