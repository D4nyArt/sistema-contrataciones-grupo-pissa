...
export default function PdfModal({ pdfUrl, type, onClose, onAccept }: PdfModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="bg-white p-4 rounded-xl max-w-4xl w-full max-h-screen overflow-auto">
      ...
      <div className="bg-white md:bg-white p-8 rounded-xl shadow-lg w-full md:w-1/2 flex flex-col items-center gap-6">
        ...
        <div className="mt-4 flex flex-col items-end">
          ...
          <button
            ...
            className="px-4 py-2 bg-[#2d4583] text-white rounded-lg hover:bg-[#08b177] disabled:opacity-50 cursor-pointer"
          >
