...
import {KeyRound, User, Users, House, Archive, Handshake, UserPlus, UserPen, Bell, Clock, LockKeyhole} from "lucide-react";
...
const linksRH = [
  ...
  { name: 'Seguridad', href: '/dashboard/security/recover', icon: LockKeyhole},
