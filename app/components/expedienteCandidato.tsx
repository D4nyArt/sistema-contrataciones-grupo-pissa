...
export default function ExpedienteCandidato({userId}: ExpedienteCandidatoProps) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-4">
      {/* Lado izquierdo */}
      <div className="lg:w-1/4 w-full bg-white rounded-xl shadow p-4 hidden md:block max-h-120 overflow-y-auto">
      ...
      {/* Lado derecho */}
      <div className="flex-1 bg-white rounded-xl shadow p-4 md:max-h-120 overflow-y-auto">
