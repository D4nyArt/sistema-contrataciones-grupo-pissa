/**
 * lista-candidatos.tsx
 *
 * Proporciona una interfaz completa para listar y gestionar candidatos del sistema.
 *
 * Este componente presenta una vista de administración que permite al personal de RH
 * visualizar todos los candidatos registrados con opciones de búsqueda, filtrado y
 * ordenamiento. Incluye dos modos de visualización (grid de tarjetas y tabla) y
 * funcionalidad de búsqueda en tiempo real por múltiples criterios como nombre,
...
/**
 * Renderiza una interfaz completa de listado y gestión de candidatos.
 *
 * Este componente proporciona una experiencia de administración completa para el
 * personal de RH, permitiendo visualizar todos los candidatos del sistema con
 * funcionalidades avanzadas de búsqueda, filtrado y ordenamiento. Incluye dos
 * modos de visualización intercambiables (grid de tarjetas para vista rápida
 * y tabla para vista detallada) con búsqueda en tiempo real por múltiples campos.
 *
 * @returns El elemento JSX que renderiza la interfaz completa de listado de candidatos.
 *
 * @example
 * ```tsx
 ...
 * // 2. Filtra solo los candidatos (rol = "candidato")
...
export default function ListUsers() {
  ...
  /**
   * Lista filtrada de usuarios que contiene solo candidatos y coincide con el término de búsqueda.
   *
   * Esta función de filtrado:
   * 1. Filtra solo usuarios con rol "candidato"
  ...
  /**
   * Lista ordenada de usuarios candidatos según la opción de ordenamiento seleccionada.
   *
  ...
  return (
    <main className="flex-1 p-4">
      ...
      {activo === "grid" ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 content-center">
