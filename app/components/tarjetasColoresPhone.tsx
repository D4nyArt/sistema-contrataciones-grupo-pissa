    ...
    <div className="overflow-x-auto">
      <div className="flex flex-row space-x-6 animate-fade-in-up w-max ">
        <Link href="/candidato/expediente?tab=expediente">
          <div className="bg-[#bdabfa] rounded-xl p-4 text-[#0d324f] w-52 h-60 space-y-2 cursor-pointer transition-transform transform hover:scale-105">
        ...
        <Link href="/candidato/expediente?tab=contratos">
          <div className="bg-[#fee6c2] rounded-xl p-4 text-[#0d324f] w-52 h-60 space-y-2 cursor-pointer transition-transform transform hover:scale-105">
        ...
        <Link href="/candidato/onboarding">
          <div className="bg-[#e9ff70] rounded-xl p-4 text-[#0d324f] w-52 h-60 space-y-2 cursor-pointer transition-transform transform hover:scale-105">
